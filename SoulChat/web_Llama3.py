...
def load_model():
    ...
    # base_path = './EmoLLM-Llama3-8B-Instruct3.0/chg0901/EmoLLM-Llama3-8B-Instruct3.0'
    base_path = '/root/.cache/modelscope/hub/YIRONGCHEN/SoulChat2.0-Llama-3.1-8B'
    # os.system(f'git clone https://code.openxlab.org.cn/chg0901/EmoLLM-Llama3-8B-Instruct3.0.git {base_path}')
    # os.system(f'cd {base_path} && git lfs pull')
    

    model = AutoModelForCausalLM.from_pretrained(base_path, device_map="auto", trust_remote_code=True, torch_dtype=torch.bfloat16).eval()
    # model.eval()
